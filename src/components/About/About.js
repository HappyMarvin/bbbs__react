      ...
      <section className="about__organization">
        ...
        <article className="about__organization-text">
          <p className="about__organization-paragraph">
            &laquo;Старшие Братья Старшие Сестры&raquo;&nbsp;&mdash;
            межрегиональная общественная организация содействия воспитанию
            подрастающего поколения. Мы&nbsp;поддерживаем детей, которым
            требуется внимание: оставшихся без попечения родителей, приемных,
            детей из&nbsp;неполных, многодетных или неблагополучных семей, детей
