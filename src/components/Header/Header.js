    ...
    <header class="header">
      <div class="header__wrapper">
        ...
        <nav class="header__action">
          ...
          <a
            href="#"
            class="header__button-login header__button-login_unauthorized"
          ></a>
        </nav>
      </div>
          ...
          <nav class="header__menu-burger">
            <ul class="header__burger-list">
              <li class="header__burger-item">
                <a href="./pages-html/about.html" class="header__burger-link">
                  О проекте
                </a>
              </li>
              <li class="header__burger-item">
                <a href="#" class="header__burger-link calender-open">
                  Календарь
                </a>
              </li>
              <li class="header__burger-item">
